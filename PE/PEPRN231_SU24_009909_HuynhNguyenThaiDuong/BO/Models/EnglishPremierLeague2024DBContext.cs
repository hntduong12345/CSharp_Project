...
namespace BO.Models
{
    public partial class EnglishPremierLeague2024DBContext : DbContext
    {
        ...
        private string GetConnectionString()
        {
            ...
            var connStr = configuration["ConnectionStrings:DefaultDB"];
            return connStr;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PremierLeagueAccount>(entity =>
            {
                entity.HasKey(e => e.AccId)
                    .HasName("PK__PremierL__91CBC3982CE35953");

                entity.ToTable("PremierLeagueAccount");

                entity.HasIndex(e => e.EmailAddress, "UQ__PremierL__49A147401FB9D92D")
                    .IsUnique();
